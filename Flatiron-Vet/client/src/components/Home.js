...
function Home() {
    ...
    return(
        ...
        <div class="secondContainer">
            <div class="oneAbove"><h2>I can be anywhere, anytime</h2></div>
            <div class="pics">
                <div class="picOne">
                    <p>And I can kill you</p>
                </div>
                <div class="picTwo">
                    <p>In over seven hundred ways</p>
                </div>
                <div class="picThree">
                <p>And that's just with my bare hands</p>
                </div>
                <div class="picFour">
                    <p>I am extensively trained in unarmed combat</p>
                </div>
            </div>
        </div>
        ...
        <div class="fourthContainer">
            <div class="blueBox">
                <div class="boxText">
                    <h4>I will shit fury all over you</h4>
                    <p> and you will drown in it.</p>
                </div>
                <div class="boxButton">
                    <a href="https://www.youtube.com/watch?v=MioT-7egSxg"><button class="btn btn-outline-white">You're fucking dead, kiddo.</button></a>
                </div>
            </div>
        </div>
    </main>
